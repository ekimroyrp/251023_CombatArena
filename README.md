...
3. Use the on-screen GUI to tweak seed, grid size, floor count, corridors, and prop spawn rates. Press **Roll Seed** to quickly try new layouts with the current settings.
